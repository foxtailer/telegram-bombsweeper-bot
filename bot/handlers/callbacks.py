...
async def callback_newgame(
    ...
    newgame_dict = {
        "game_id": game_id,
        "game_data": get_fake_newgame_data(size, bombs)
    }
...
async def callback_open_square(
    ...
    if game_data["initial"] is True:
        cells = get_real_game_data(
            game_data["size"], game_data["bombs"], (x, y))
    ...
    # This cell contained a number
        ...
        # There are more flags than there should be
            ...
            await call.answer(
                show_alert=True,
                text="Looks like you've placed more flags than "\
                    "there are bombs on field. Please check them again.",
            )
            return
